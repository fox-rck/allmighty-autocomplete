...
app.factory('MovieRetriever', function ($http, $q, $timeout) {
    ...
    MovieRetriever.getmovies = function (i) {
        ...
        //For use with object array
        var someMovies = [{ id: 1, name: "The Wolverine" }, { id: 2, name: "The Smurfs 2" }, { id: 3, name: "The Mortal Instruments: City of Bones" }, { id: 4, name: "Drinking Buddies" }, { id: 5, name: "All the Boys Love Mandy Lane" }, { id: 6, name: "The Act Of Killing" }];
        var moreMovies = [{ id: 1, name: "The Wolverine" }, { id: 2, name: "The Smurfs 2" }, { id: 3, name: "The Mortal Instruments: City of Bones" }, { id: 4, name: "Drinking Buddies" }, { id: 5, name: "All the Boys Love Mandy Lane" }, { id: 6, name: "The Act Of Killing" }];
